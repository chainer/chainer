...
And the distribution :math:`{\bf s} \sim p_{\mathrm model}({\bf s})`
generated by :math:`G({\bf x})` can match the true distribution :math:`{\bf s} \sim p_({\bf s})`.
...
.. image:: ../../image/dcgan/update-gan.png
