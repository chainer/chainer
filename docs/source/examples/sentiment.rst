...
After that, we convert each tokenized sample to a tree structure data  by ``convert_tree``. By doing like this,
...
3. (Advanced) Mini-batching in Recursive Neural Network[3]
===========================================================
...
Recursive Neural Network has two operations: Operation A for computing an embedding vector for the leaf node.
