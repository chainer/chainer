...
class VariableNode(object):
    ...
    _rank = 0  # type: int
    # Name of the Function or FunctionNode is assigned if backpropagation from
    # this variable is disabled, e.g. a gradient generated by an old-style
    # Function or with config `enable_backprop=False`.
    _disabled_grad_generator = None  # type: tp.Tuple[Exception, str]
