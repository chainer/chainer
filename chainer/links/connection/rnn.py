...
class RNN(link.ChainList):

    """The generic Recurrent Neural Network link (RNN).

    This is an implementation of a generic Recurrent Neural Network.
    ...
    Attributes:
          num_layers (int): Indicates the number of RNN layers
          cell_type (~chainer.Chain or ~chainer.ChainList):
