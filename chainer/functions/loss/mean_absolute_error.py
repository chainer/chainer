...
def mean_absolute_error(x0, x1):
    ...
    is taken over the minibatch. Args ``x0`` and ``x1`` must be of the same
    dimension. This function calculates the absolute value differences of
    corresponding elements in x0 and x1, and returns the mean of those
    differences.
