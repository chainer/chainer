...
std::tuple<std::shared_ptr<void>, size_t> NativeDevice::TransferDataFrom(Device& src_device,
...
std::tuple<std::shared_ptr<void>, size_t> NativeDevice::TransferDataTo(Device& dst_device,
                                                                       const std::shared_ptr<void>& src_ptr,
                                                                       size_t offset,
                                                                       size_t bytesize) {
