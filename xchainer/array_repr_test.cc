...
TEST(ArrayReprTest, AllDtypesOnNativeBackend) {
    ...
    CheckArrayRepr<float>("array([-3.25], shape=(1,), dtype=float32, device='native:0')", {-3.25}, Shape({1}), device);
    CheckArrayRepr<float>("array([ inf], shape=(1,), dtype=float32, device='native:0')", {std::numeric_limits<float>::infinity()},
                          Shape({1}), device);
    CheckArrayRepr<float>("array([ -inf], shape=(1,), dtype=float32, device='native:0')", {-std::numeric_limits<float>::infinity()},
                          Shape({1}), device);
    ...
    CheckArrayRepr<double>("array([-3.25], shape=(1,), dtype=float64, device='native:0')", {-3.25}, Shape({1}), device);
    CheckArrayRepr<double>("array([ inf], shape=(1,), dtype=float64, device='native:0')", {std::numeric_limits<double>::infinity()},
                           Shape({1}), device);
    CheckArrayRepr<double>("array([ -inf], shape=(1,), dtype=float64, device='native:0')", {-std::numeric_limits<double>::infinity()},
                           Shape({1}), device);
    ...
    // Single graph
    CheckArrayRepr<int32_t>("array([-2], shape=(1,), dtype=int32, device='native:0', graph_ids=['graph_1'])", {-2}, Shape({1}), device,
                            {"graph_1"});

    // Two graphs
    CheckArrayRepr<int32_t>("array([1], shape=(1,), dtype=int32, device='native:0', graph_ids=['graph_1', 'graph_2'])", {1}, Shape({1}),
                            device, {"graph_1", "graph_2"});

    // Multiple graphs
    CheckArrayRepr<int32_t>(
        "array([-9], shape=(1,), dtype=int32, device='native:0', graph_ids=['graph_1', 'graph_2', 'graph_3', 'graph_4', 'graph_5'])", {-9},
