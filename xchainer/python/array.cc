...
void InitXchainerArray(pybind11::module& m) {
    py::class_<ArrayBody, ArrayBodyPtr> cls{m, "Array", py::buffer_protocol()};
    cls.def_buffer(&MakeNumpyArrayFromArray);
    cls.def(py::init(py::overload_cast<const py::tuple&, Dtype, const py::list&, const nonstd::optional<std::string>&>(&MakeArray)),
            py::arg("shape"),
            py::arg("dtype"),
            py::arg("data"),
            py::arg("device") = nullptr);
    cls.def(py::init(py::overload_cast<py::array, const nonstd::optional<std::string>&>(&MakeArray)),
            py::arg("data"),
            py::arg("device") = nullptr);
    cls.def("view", [](const ArrayBodyPtr& self) {
        // Duplicate the array body
        return std::make_shared<ArrayBody>(*self);
    });
    cls.def("__iadd__", [](const ArrayBodyPtr& self, const ArrayBodyPtr& rhs) { return (Array{self} += Array{rhs}).move_body(); });
    cls.def("__imul__", [](const ArrayBodyPtr& self, const ArrayBodyPtr& rhs) { return (Array{self} *= Array{rhs}).move_body(); });
    cls.def("__add__", [](const ArrayBodyPtr& self, const ArrayBodyPtr& rhs) { return (Array{self} + Array{rhs}).move_body(); });
    cls.def("__mul__", [](const ArrayBodyPtr& self, const ArrayBodyPtr& rhs) { return (Array{self} * Array{rhs}).move_body(); });
    cls.def("__repr__", [](const ArrayBodyPtr& self) { return Array{self}.ToString(); });
    cls.def("__getitem__", [](const ArrayBodyPtr& self, py::handle handle) {
        return Array{self}.At(python::internal::MakeArrayIndices(handle)).move_body();
    });
    cls.def("to_device", [](const ArrayBodyPtr& self, Device& device) { return Array{self}.ToDevice(device).move_body(); });
    cls.def("to_device", [](const ArrayBodyPtr& self, const std::string& device_name) {
        Device& device = GetDefaultContext().GetDevice({device_name});
        return Array{self}.ToDevice(device).move_body();
    });
    cls.def("to_device", [](const ArrayBodyPtr& self, const std::string& backend_name, int index) {
        Device& device = GetDefaultContext().GetDevice({backend_name, index});
        return Array{self}.ToDevice(device).move_body();
    });
    cls.def("transpose", [](const ArrayBodyPtr& self) { return Array{self}.Transpose().move_body(); });
    cls.def("reshape", [](const ArrayBodyPtr& self, py::tuple shape) { return Array{self}.Reshape(ToShape(shape)).move_body(); });
    cls.def("reshape", [](const ArrayBodyPtr& self, const std::vector<int64_t>& shape) {
        return Array{self}.Reshape({shape.begin(), shape.end()}).move_body();
    });
    cls.def("reshape", [](const ArrayBodyPtr& self, py::args args) {
    ...
    cls.def("sum",
            ...
            py::arg("axis") = nullptr,
            py::arg("keepdims") = false);
    cls.def("copy", [](const ArrayBodyPtr& self) { return Array{self}.Copy().move_body(); });
    cls.def("as_constant",
    ...
    cls.def_property_readonly("dtype", [](const ArrayBodyPtr& self) { return Array{self}.dtype(); });
    cls.def_property_readonly("element_bytes", [](const ArrayBodyPtr& self) { return Array{self}.element_bytes(); });
    cls.def_property_readonly("is_contiguous", [](const ArrayBodyPtr& self) { return Array{self}.IsContiguous(); });
    cls.def_property_readonly("ndim", [](const ArrayBodyPtr& self) { return Array{self}.ndim(); });
    cls.def_property_readonly("offset", [](const ArrayBodyPtr& self) { return Array{self}.offset(); });
    cls.def_property_readonly("shape", [](const ArrayBodyPtr& self) { return ToTuple(Array{self}.shape()); });
    cls.def_property_readonly("strides", [](const ArrayBodyPtr& self) { return ToTuple(Array{self}.strides()); });
    cls.def_property_readonly("total_bytes", [](const ArrayBodyPtr& self) { return Array{self}.GetTotalBytes(); });
    cls.def_property_readonly("total_size", [](const ArrayBodyPtr& self) { return Array{self}.GetTotalSize(); });
    cls.def_property_readonly("T", [](const ArrayBodyPtr& self) { return Array{self}.Transpose().move_body(); });
    cls.def_property_readonly(
    ...
    cls.def_property_readonly("_debug_flat_data", [](const ArrayBodyPtr& self) {
        py::list list;
        Array array{self};
