...
void InitXchainerBackpropModeScope(pybind11::module& m, const char* class_name, const char* function_name) {
    ...
    m.def(function_name, [](GraphId graph_id) { return PyBackpropModeScope<BackpropModeScope>{{graph_id}}; });
...
void InitXchainerBackpropMode(pybind11::module& m) {
    ...
    m.def("is_backprop_required",
          [](const nonstd::optional<GraphId>& graph_id, py::handle context) { return IsBackpropRequired(graph_id, GetContext(context)); },
