...
Array Array::FromContiguousHostMemory(const Shape& shape, Dtype dtype, const std::shared_ptr<void>& data, Device& device) {
    return internal::FromHostMemory(shape, dtype, data, {shape, dtype}, device);
}
