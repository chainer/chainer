...
#include <stdlib.h>  // NOLINT(readability/nolint), NOLINT(modernize-deprecated-headers), clang-tidy recommends to use cstdlib, but setenv is not included in cstdlib
