...
public:
    ...
    virtual std::tuple<std::shared_ptr<void>, size_t> TransferDataFrom(Device& src_device,
    ...
    //
    // It returns a tuple of (data, offset).
    virtual std::tuple<std::shared_ptr<void>, size_t> TransferDataTo(Device& dst_device,
                                                                     const std::shared_ptr<void>& src_ptr,
                                                                     size_t offset,
                                                                     size_t bytesize) = 0;
