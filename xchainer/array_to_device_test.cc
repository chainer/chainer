...
TEST_P(ArrayToDeviceCompatibleTest, ToDevice) {
    ...
    Array a = Array::FromContiguousHostMemory({2, 1}, Dtype::kFloat32, std::shared_ptr<float>(data, nop), src_dev);
...
TEST(ArrayToDeviceArithmeticTest, Arithmetic) {
    ...
    Shape shape{2, 1};
    Array a0 = Array::FromContiguousHostMemory(shape, Dtype::kFloat32, std::shared_ptr<float>(data0, nop), dev0);
    Array a1 = Array::FromContiguousHostMemory(shape, Dtype::kFloat32, std::shared_ptr<float>(data1, nop), dev0);
    Array a2 = Array::FromContiguousHostMemory(shape, Dtype::kFloat32, std::shared_ptr<float>(data2, nop), dev1);
    a0.RequireGrad();
    a1.RequireGrad();
    a2.RequireGrad();
    ...
    ExpectArraysEqual(c, Array::FromContiguousHostMemory(shape, Dtype::kFloat32, std::shared_ptr<float>(datay, nop)));
    ...
    ExpectArraysEqual(*a0.GetGrad(), Array::FromContiguousHostMemory(shape, Dtype::kFloat32, std::shared_ptr<float>(data0_grad, nop)));
    ExpectArraysEqual(*a1.GetGrad(), Array::FromContiguousHostMemory(shape, Dtype::kFloat32, std::shared_ptr<float>(data1_grad, nop)));
    ExpectArraysEqual(*a2.GetGrad(), Array::FromContiguousHostMemory(shape, Dtype::kFloat32, std::shared_ptr<float>(data2_grad, nop)));
}
