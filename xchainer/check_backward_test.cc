...
protected:
    void CheckBackwardBaseComputation(bool expect_correct,
                                      const Fprop& fprop,
                                      Arrays& inputs,
...
protected:
    ...
    void CheckBackwardUnaryComputation(bool expect_correct,
                                       const Fprop& fprop,
                                       const Shape& shape,
                                       Data input_data,
...
protected:
    ...
    template <typename Data>
    void CheckBackwardBinaryComputation(bool expect_correct,
                                        const Fprop& fprop,
                                        const Shape& shape,
                                        Data input_data1,
                                        Data input_data2,
...
protected:
    void CheckDoubleBackwardBaseComputation(const Fprop& fprop,
                                            Arrays& inputs,
                                            Arrays& grad_outputs,
...
protected:
    template <typename Data>
    void CheckDoubleBackwardUnaryComputation(const Fprop& fprop,
                                             const Shape& shape,
                                             Data input_data,
                                             Data grad_output_data,
...
protected:
    template <typename Data>
    void CheckDoubleBackwardBinaryComputation(const Fprop& fprop,
                                              const Shape& shape,
                                              Data input_data1,
                                              Data input_data2,
                                              Data grad_output_data,
...
TEST_P(CheckBackwardBinaryTest, IncorrectBackward) {
    ...
    CheckBackwardBinaryComputation(false,
...
TEST_F(CheckDoubleBackwardBinaryTest, CorrectBackward) {
    ...
    Data eps_grad_output_data{1e-3f, 1e-3f, 1e-3f};
    Fprop fprop = [](const Arrays& inputs) -> Arrays { return {inputs[0] * inputs[1]}; };
    CheckDoubleBackwardBinaryComputation(fprop,
                                         {1, 3},
                                         input_data1,
                                         input_data2,
                                         grad_output_data,
