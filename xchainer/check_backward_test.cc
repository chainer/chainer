...
Arrays IncorrectBackwardUnaryFunc(const Arrays& inputs) {
    ...
    auto backward_function = [](const GraphId&, const Array& gout) { return gout * gout; };
...
Arrays IncorrectBackwardBinaryFunc(const Arrays& inputs) {
    ...
    auto lhs_backward_function = [other = rhs](const GraphId& graph_id, const Array& gout)->Array { return gout + other.MakeGradStoppingView(graph_id); };
