...
TEST_F(CheckBackwardTest, CorrectBackward) {
    ...
    inputs[1].set_requires_grad(false);

    auto fprop = [](const Arrays& inputs) -> Arrays {
    ...
    CheckCheckBackwardComputation(true, inputs, grad_outputs, eps, atol, rtol, fprop);
}
