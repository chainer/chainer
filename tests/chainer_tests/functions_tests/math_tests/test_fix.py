...
class TestFix(UnaryFunctionsTestBase):
    ...
    def test_forward_cpu(self):
        self.check_forward_cpu(F.fix, numpy.fix)

    @attr.gpu
    def test_forward_gpu(self):
        self.check_forward_gpu(F.fix, cuda.cupy.fix)

    def test_backward_cpu(self):
        self.check_backward_cpu(F.fix)

    @attr.gpu
    def test_backward_gpu(self):
        self.check_backward_gpu(F.fix)

    def test_double_backward_cpu(self):
        self.check_double_backward_cpu(F.fix)

    @attr.gpu
    def test_double_backward_gpu(self):
        self.check_double_backward_gpu(F.fix)

    def test_label(self):
        self.check_label(F.Fix, 'fix')
