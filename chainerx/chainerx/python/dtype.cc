...
Dtype GetDtype(py::handle handle) {
    ...
    if (handle.is(py::module::import("numpy").attr("bool_"))) return Dtype::kBool;
    if (handle.is(py::module::import("numpy").attr("int8"))) return Dtype::kInt8;
    if (handle.is(py::module::import("numpy").attr("int16"))) return Dtype::kInt16;
    if (handle.is(py::module::import("numpy").attr("int32"))) return Dtype::kInt32;
    if (handle.is(py::module::import("numpy").attr("int64"))) return Dtype::kInt64;
    if (handle.is(py::module::import("numpy").attr("uint8"))) return Dtype::kUInt8;
    if (handle.is(py::module::import("numpy").attr("float32"))) return Dtype::kFloat32;
    if (handle.is(py::module::import("numpy").attr("float64"))) return Dtype::kFloat64;
