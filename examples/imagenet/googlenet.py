...
class GoogLeNet(chainer.Chain):
    ...
    def __call__(self, x, t):
        ...
        l0 = F.average_pooling_2d(h, 5, stride=3)
        l1 = F.relu(self.loss1_conv(l0))
        l2 = F.relu(self.loss1_fc1(l1))
        l3 = self.loss1_fc2(l2)
        loss1 = F.softmax_cross_entropy(l3, t)
        ...
        l0 = F.average_pooling_2d(h, 5, stride=3)
        l1 = F.relu(self.loss2_conv(l0))
        l2 = F.relu(self.loss2_fc1(l1))
        l3 = self.loss2_fc2(l2)
        loss2 = F.softmax_cross_entropy(l3, t)
