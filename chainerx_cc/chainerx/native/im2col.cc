...
Array Im2Col(
    ...
    VisitDtype(x.dtype(), [&](auto pt) {
        ...
        switch (ndim) {
            case 0:
                Im2ColImpl<T, 0>(padded_x, out, kernel_size, stride, dilation, out_dims, batch_channel_indexer);
                break;
            case 1:
                Im2ColImpl<T, 1>(padded_x, out, kernel_size, stride, dilation, out_dims, batch_channel_indexer);
                break;
            case 2:
                Im2ColImpl<T, 2>(padded_x, out, kernel_size, stride, dilation, out_dims, batch_channel_indexer);
                break;
            case 3:
                Im2ColImpl<T, 3>(padded_x, out, kernel_size, stride, dilation, out_dims, batch_channel_indexer);
                break;
            case 4:
                Im2ColImpl<T, 4>(padded_x, out, kernel_size, stride, dilation, out_dims, batch_channel_indexer);
                break;
            default:
