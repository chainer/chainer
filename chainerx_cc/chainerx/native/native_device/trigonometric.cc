...
namespace internal {
CHAINERX_REGISTER_KEY_KERNEL(Sin)
CHAINERX_REGISTER_KEY_KERNEL(Cos)
CHAINERX_REGISTER_KEY_KERNEL(Tan)
CHAINERX_REGISTER_KEY_KERNEL(Arcsin)
CHAINERX_REGISTER_KEY_KERNEL(Arccos)
CHAINERX_REGISTER_KEY_KERNEL(Arctan)
CHAINERX_REGISTER_KEY_KERNEL(Arctan2)
}  // namespace internal
