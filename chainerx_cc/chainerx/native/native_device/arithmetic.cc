...
namespace internal {
CHAINERX_REGISTER_KEY_KERNEL(Add)
CHAINERX_REGISTER_KEY_KERNEL(AddAS)
CHAINERX_REGISTER_KEY_KERNEL(Subtract)
CHAINERX_REGISTER_KEY_KERNEL(SubtractAS)
CHAINERX_REGISTER_KEY_KERNEL(Multiply)
CHAINERX_REGISTER_KEY_KERNEL(MultiplyAS)
CHAINERX_REGISTER_KEY_KERNEL(FloorDivide)
CHAINERX_REGISTER_KEY_KERNEL(FloorDivideAS)
CHAINERX_REGISTER_KEY_KERNEL(FloorDivideSA)
CHAINERX_REGISTER_KEY_KERNEL(Divide)
CHAINERX_REGISTER_KEY_KERNEL(DivideAS)
CHAINERX_REGISTER_KEY_KERNEL(DivideSA)
CHAINERX_REGISTER_KEY_KERNEL(Power)
CHAINERX_REGISTER_KEY_KERNEL(PowerAS)
CHAINERX_REGISTER_KEY_KERNEL(PowerSA)
}  // namespace internal
