...
namespace internal {
CHAINERX_REGISTER_KEY_KERNEL(Sinh)
CHAINERX_REGISTER_KEY_KERNEL(Cosh)
CHAINERX_REGISTER_KEY_KERNEL(Tanh)
CHAINERX_REGISTER_KEY_KERNEL(Arcsinh)
CHAINERX_REGISTER_KEY_KERNEL(Arccosh)
}  // namespace internal
