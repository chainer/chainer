...
namespace internal {
CHAINERX_REGISTER_KEY_KERNEL(BitwiseAnd)
CHAINERX_REGISTER_KEY_KERNEL(BitwiseAndAS)
CHAINERX_REGISTER_KEY_KERNEL(BitwiseOr)
CHAINERX_REGISTER_KEY_KERNEL(BitwiseOrAS)
CHAINERX_REGISTER_KEY_KERNEL(BitwiseXor)
CHAINERX_REGISTER_KEY_KERNEL(BitwiseXorAS)
CHAINERX_REGISTER_KEY_KERNEL(LeftShiftAA)
CHAINERX_REGISTER_KEY_KERNEL(LeftShiftAS)
CHAINERX_REGISTER_KEY_KERNEL(LeftShiftSA)
CHAINERX_REGISTER_KEY_KERNEL(RightShiftAA)
CHAINERX_REGISTER_KEY_KERNEL(RightShiftAS)
CHAINERX_REGISTER_KEY_KERNEL(RightShiftSA)
}  // namespace internal
