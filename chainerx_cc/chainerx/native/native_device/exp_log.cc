...
namespace internal {
CHAINERX_REGISTER_KEY_KERNEL(Erf)
CHAINERX_REGISTER_KEY_KERNEL(Exp)
CHAINERX_REGISTER_KEY_KERNEL(Expm1)
CHAINERX_REGISTER_KEY_KERNEL(Exp2)
CHAINERX_REGISTER_KEY_KERNEL(Log)
CHAINERX_REGISTER_KEY_KERNEL(Log10)
CHAINERX_REGISTER_KEY_KERNEL(Log2)
CHAINERX_REGISTER_KEY_KERNEL(Log1p)
}  // namespace internal
