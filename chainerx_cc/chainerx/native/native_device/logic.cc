...
namespace internal {
CHAINERX_REGISTER_KEY_KERNEL(Equal)
CHAINERX_REGISTER_KEY_KERNEL(NotEqual)
CHAINERX_REGISTER_KEY_KERNEL(Greater)
CHAINERX_REGISTER_KEY_KERNEL(GreaterEqual)
CHAINERX_REGISTER_KEY_KERNEL(LogicalNot)
CHAINERX_REGISTER_KEY_KERNEL(LogicalAnd)
CHAINERX_REGISTER_KEY_KERNEL(LogicalOr)
CHAINERX_REGISTER_KEY_KERNEL(LogicalXor)
CHAINERX_REGISTER_KEY_KERNEL(All)
CHAINERX_REGISTER_KEY_KERNEL(Any)
CHAINERX_REGISTER_KEY_KERNEL(IsNan)
CHAINERX_REGISTER_KEY_KERNEL(IsInf)
CHAINERX_REGISTER_KEY_KERNEL(IsFinite)
}  // namespace internal
